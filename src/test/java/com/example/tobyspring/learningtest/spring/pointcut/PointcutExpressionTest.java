package com.example.tobyspring.learningtest.spring.pointcut;
...
class PointcutExpressionTest {
    ...
    public void methodSignaturePointcut() throws SecurityException, NoSuchMethodException {
        ...
        pointcut.setExpression("execution(public int " + "com.example.tobyspring.learningtest.spring.pointcut.Target.minus(int,int) " + "throws java.lang.RuntimeException)");

        // Target.minus()
        assertThat(pointcut.getClassFilter().matches(Target.class) && pointcut.getMethodMatcher().matches(Target.class.getMethod("minus", int.class, int.class), null)).isEqualTo(true);

        // Target.plus()
        assertThat(pointcut.getClassFilter().matches(Target.class) && pointcut.getMethodMatcher().matches(Target.class.getMethod("plus", int.class, int.class), null)).isEqualTo(false);

        // Bean.method()
        assertThat(pointcut.getClassFilter().matches(Bean.class) && pointcut.getMethodMatcher().matches(Target.class.getMethod("method"), null)).isEqualTo(false);
    }
    ...
    public void pointcutMatches(String expression, Boolean expected, Class<?> clazz, String methodName, Class<?>... args) throws Exception {
        ...
        assertThat(pointcut.getClassFilter().matches(clazz) && pointcut.getMethodMatcher().matches(clazz.getMethod(methodName, args), null)).isEqualTo(expected);
    }
    ...
    public void pointcut() throws Exception {
        ...
        targetClassPointcutMatches("execution(* com.example.tobyspring.learningtest.spring.pointcut.Target.*(..))", true, true, true, true, true, false);
        targetClassPointcutMatches("execution(* com.example.tobyspring.learningtest.spring.pointcut.*.*(..))", true, true, true, true, true, true);
        targetClassPointcutMatches("execution(* com.example.tobyspring.learningtest.spring.pointcut..*.*(..))", true, true, true, true, true, true);
